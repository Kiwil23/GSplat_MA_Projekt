...
Also you need eduVPN and connect with "Münchner Wissenschaftsnetz LRZ-VPN".
...
2. Copy `Pipeline/cluster/splat_workspace` to your cluster home directory. You may need to run ```sed -i 's/\r$//' gpu_job.sbatch ``` first
